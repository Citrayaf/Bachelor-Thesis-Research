             ...
             for br=1:m
                 ...
                 for kili=1:length(jadi)
                     if countz<k
                        ...
                        if jumnil1(1,jadi(kili))<3   %3 means that girth 4 can be formed, so we avoided it
                           if H(jadi(kili),j)~=1
                               H(jadi(kili),j)=1;
                               countz=countz+1;
                           end
...
%Equation to find the minimum girth 
